...
datafile="BenignMalignant_58markers_23JAN08_subtype_grouping_indeterminates.2.txt"
#outfile="BenignMalignant_58markers_23JAN08_ungrouped_MannWhitney_subtypes2.txt"
outfile="BenignMalignant_58markers_23JAN08_ungrouped_MannWhitney_subtypes3.txt"
...
#Get marker data
marker_data=data[,40:96] #ungrouped values
...
for (i in 1:length(marker_data)){
   ...
   benign_mean_rank=mean(ranked_marker_data[target=="Foll_Ben"], na.rm=TRUE)
   malig_mean_rank=mean(ranked_marker_data[target=="Foll_Mal"], na.rm=TRUE)
