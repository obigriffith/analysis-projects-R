...
setwd("C:/Documents and Settings/obig/My Documents/Projects/Thyroid_markers/Anaplastic/complete_cohort_analysis/ATC_vs_DTC/LN_analysis")
outfile="BenignMalignant_58markers_23JAN08_ungrouped_LNanalysis.txt"

primary_marker_data=data[,c("TOPO2","TG","KI67","ECAD","P53","BetaCatenin","BCL2","VEGF")]
LN_marker_data=data[,c("TOPO2_LN","TG_LN","KI67_LN","ECAD_LN","P53_LN","BetaCatenin_LN","BCL2_LN","VEGF_LN")]
