...
setwd("C:/Documents and Settings/obig/My Documents/Projects/Thyroid_markers/Anaplastic/complete_cohort_analysis/ATC_vs_DTC/DTC_prognostic_stats")
...
#Exclude any cases you do not want used (e.g. in this case we do not want any M or HCC tumors where path=3 or 4)
path=data[,13]
data=data[path<3,] #Exclude M malignancies
path=data[,13]
...
#Here, we are focusing on just the 8 'transformation' markers from the anaplastic transformation paper.
#Grab both group1 and group2 data for these markers.
#Note, KI67=MIB1
marker_data=data[,c("TOPO2_g1","TG_g1","KI67_g1","ECAD_g1","P53_g1","BetaCatenin_g1","BCL2_g1","VEGF_g1","TOPO2_g2","TG_g2","KI67_g2","ECAD_g2","P53_g2","BetaCatenin_g2","BCL2_g2","VEGF_g2")] #group 1 values for sig markers from diag tests
