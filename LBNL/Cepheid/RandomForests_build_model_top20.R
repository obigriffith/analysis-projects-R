...
setwd("C:/Users/Obi/Documents/My Dropbox/Projects/Cepheid/analyzing/analysis_final2/RandomForests/unbalanced/final_100k_trees/finaltop20/")
...
outfile_top20="Cepheid_RFoutput_top20.txt"
...
#Get top 20 predictor variables (by Var Imp only, no optimizing)
top20_probes=c("9133_at","9833_at","201291_s_at","29127_at","1164_at","208079_s_at","9055_at","218039_at","9837_at","4171_at","9768_at","203554_x_at","204767_s_at","6241_at","203213_at","202954_at","51659_at","10682_at","8772_at","207828_s_at")
top20_data=rawdata[rawdata[,1]%in%top20_probes,]

#Get pre-selected optimized top 20/25 predictor variables
top20opt_probes=c("204767_s_at","10682_at","201291_s_at","9133_at","1164_at","208079_s_at","23224_at","55435_at","23220_at","201461_s_at","218750_at","57613_at","202709_at","57122_at","23405_at","201483_s_at","29127_at","204416_x_at","10628_at","211074_at")
top25opt_probes=c("204767_s_at","10682_at","201291_s_at","9133_at","1164_at","208079_s_at","23224_at","55435_at","23220_at","201461_s_at","218750_at","57613_at","202709_at","57122_at","23405_at","201483_s_at","29127_at","204416_x_at","10628_at","211074_at","4171_at","9833_at","218039_at","9055_at","358_at")
top20opt_data=rawdata[rawdata[,1]%in%top20opt_probes,]
top25opt_data=rawdata[rawdata[,1]%in%top25opt_probes,]

predictor_data=t(top20opt_data[,4:length(header)]) #Top20 optimized list
predictor_names=paste(top20opt_data[,3]," (",top20opt_data[,1],")", sep="") #gene symbol + probe ids
...
save(rf_output, file="RF_model_20gene_optimized")
...
varImpPlot(rf_output, type=2, n.var=30, scale=FALSE, main="Variable Importance (Gini) for top 20 predictors")
dev.off()
