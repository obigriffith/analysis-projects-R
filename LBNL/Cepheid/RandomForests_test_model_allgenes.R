...
setwd("C:/Users/Obi/Documents/My Dropbox/Projects/Cepheid/analyzing/analysis_final2/RandomForests/test_survival/allgene/")
RF_model_file="C:/Users/Obi/Documents/My Dropbox/Projects/Cepheid/analyzing/analysis_final2/RandomForests/train_survival/unbalanced/final_100k_trees_repeat/RF_model"
...
predictor_names=paste(rawdata[,3]," (",rawdata[,1],")", sep="") #gene symbol + probe ids
...
RF_predictions_vs_relapse_10yrFU=clindata_plusRF[!is.na(clindata_plusRF[,"X10yr_relapse"]),c("X10yr_relapse","RF_predictions_responses","Relapse")]
...
write(c(sens_out,spec_out,acc_out,err_out,class1_error_out,class2_error_out,misclass_1,misclass_2,AUC_out), file=outfile, append=TRUE)
