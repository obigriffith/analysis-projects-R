...
#KnownJunction
#datafile="C:/Users/Obi/Documents/My Dropbox/Projects/BCCL/ALEXA/67libs/matrix/Matrix_KnownJunctionExpression_v53.txt"
#expressedfile="C:/Users/Obi/Documents/My Dropbox/Projects/BCCL/ALEXA/67libs/matrix/Expressed_KnownJunctionExpression_v53.txt"

#Set output dir for feature type
#outdir="C:/Users/Obi/Documents/My Dropbox/Projects/BCCL/ALEXA/67libs/analysis/gene/withNormalLike"
outdir="C:/Users/Obi/Documents/My Dropbox/Projects/BCCL/ALEXA/67libs/analysis/gene/noNormalLike"
#outdir="C:/Users/Obi/Documents/My Dropbox/Projects/BCCL/ALEXA/67libs/analysis/transcript/"
#outdir="C:/Users/Obi/Documents/My Dropbox/Projects/BCCL/ALEXA/67libs/analysis/KnownJunction/"

heatmap_outfile = "BCCL_Feature_expression_67libs_heatmap.pdf"
heatmap_outfile2 = "BCCL_Feature_expression_67libs_heatmap_simple.pdf"
heatmap_outfile3 = "BCCL_Feature_expression_heatmap_subtype_training_filtgenes.pdf"
heatmap_outfile3B = "BCCL_Feature_expression_heatmap_subtype_training_topgenes.pdf"
heatmap_outfile4 = "BCCL_Feature_expression_heatmap_subtype_predictions.pdf"

outfile="RFoutput.txt"
varimp_pdffile="varImps.pdf"
MDS_pdffile="MDS.pdf"
vote_dist_pdffile="vote_dist.pdf"
prob_pdffile="subtype_probs.pdf"
subtype_pred_outfile="SubtypePredictions.txt"
rf_model_file="rfmodel.Rdata"
...
#Set library names to "clean" set
...
#Retrieve cell line details, make sure data and cell line info match up
...
x=t(as.matrix(data_train))
main_title="RNAseq gene-level expression, training"
par(cex.main=0.9)
...
#Limit to top XXX genes - 300 determined to be approx optimal with experimentation for producing clean clusters with min number of genes
topgenes=sort(rf_importances[,num_classes+2], decreasing=TRUE)[1:300]
data_train_topgenes=data_train[names(topgenes),]

pdf(file=heatmap_outfile3B)
