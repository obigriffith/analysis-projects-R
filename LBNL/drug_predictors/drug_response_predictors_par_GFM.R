...
datafile=args[4]
genomicfeaturematrixfile=args[5]
core_cell_lines_string=args[6]
core_cell_lines=as.vector(strsplit(core_cell_lines_string,",")[[1]])


#Command line usage:
#/csb/home/obig/Projects/drug_predictors/drug_response_predictors_par_GFM.R 1 /csb/home/obig/Projects/drug_predictors/RFpredictors/allDrugs/genome_wide/top100/rnaseq/ "RS" /csb/home/obig/Projects/drug_predictors/combined/BCCL_combined_data.4.txt /csb/home/obig/Projects/drug_predictors/combined/GenomicFeatureMatrix100_fixedGI50threshold_datafreeze_v2.txt "600MPE,AU565,BT474,BT483,BT549,CAMA1,HCC1143,HCC1428,HCC1569,HCC1937,HCC1954,HCC202,HCC3153,HCC38,HCC70,HS578T,LY2,MCF7,MDAMB231,MDAMB361,SKBR3,SUM1315MO2,SUM149PT,SUM225CWN,SUM52PE,T47D,UACC812,ZR751,ZR75B"
...
#cell_line_datafile="/csb/home/obig/Projects/drug_predictors/BCCL_data_list.txt"
cell_line_datafile="/csb/home/obig/Projects/drug_predictors/BCCL_data_list_v2.txt"
#datafile="/csb/home/obig/Projects/drug_predictors/combined/BCCL_combined_data.3.COSMICextended.imp.txt"
#datafile="/csb/home/obig/Projects/drug_predictors/combined/BCCL_combined_data.4.imp.txt"
#datafile="/csb/home/obig/Projects/drug_predictors/combined/BCCL_combined_data.4.txt"
#drugdatafile="/csb/home/obig/Projects/drug_predictors/drugdata/LBNL_Gray_BCCL_alldrugs_10Feb.csv"
drugdatafile="/csb/home/obig/Projects/drug_predictors/drugdata/LBNL_Gray_BCCL_alldrugs_26Aug11.csv"
GI50meanfile="/csb/home/obig/Projects/drug_predictors/drugdata/GI50meanThresholds_v2.csv"

#output folders/files
#outdir_base="/csb/home/obig/Projects/drug_predictors/RFpredictors/allDrugs/core_alldata_imputed/"
#outdir_base="/csb/home/obig/Projects/drug_predictors/RFpredictors/allDrugs/independent/rnaseq/" #RNAseq - all lines
#outdir_base="/csb/home/obig/Projects/drug_predictors/RFpredictors/allDrugs/independent/exonarray/" #exon array - all lines
#outdir_base="/csb/home/obig/Projects/drug_predictors/RFpredictors/allDrugs/independent/U133A/" #U133A - all lines
#outdir_base="/csb/home/obig/Projects/drug_predictors/RFpredictors/allDrugs/independent/Meth/" #Meth - all lines
#outdir_base="/csb/home/obig/Projects/drug_predictors/RFpredictors/allDrugs/independent/mutation/" #mutation - all lines
#outdir_base="/csb/home/obig/Projects/drug_predictors/RFpredictors/allDrugs/independent/RPPA/" #RPPA - all lines
#outdir_base="/csb/home/obig/Projects/drug_predictors/RFpredictors/allDrugs/independent/SNP/" #SNP6 - all lines
...
rownames(raw_feat_data)=paste(raw_feat_data[,"DataType"],raw_feat_data[,"ID"], sep="__")

#Import Genome Feature Matrix file
GFM_import=read.table(genomicfeaturematrixfile, header = TRUE, na.strings = "NA", sep="\t")
cbind(drugs,colnames(GFM_import)) #Check to make sure drugs are in same order as in drug data
GFM_predictors=as.vector(GFM_import[,drug_i])

#Get data_type from predictor names
getPrefix=function(x){y=x[[1]][1]; return(y)}
GFM_predictor_names_split=strsplit(x=GFM_predictors, split="__")
GFM_prefixes=sapply(GFM_predictor_names_split,getPrefix, simplify = TRUE)

#Filter down to just specified datatypes/variables
GFM_predictors=GFM_predictors[which(GFM_prefixes %in% datatypes)]
data=data[GFM_predictors,]
feat_data=raw_feat_data[GFM_predictors,]
