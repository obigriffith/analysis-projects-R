...
##To fit a summary of the entire transcript (i.e. estimate the overall expression for the transcript), do:
...
write.csv(expr,file='breastExon_transcriptlevel_core_noHCC1500.csv',quote=F)
