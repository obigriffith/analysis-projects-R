...
datafile="C:/Users/Obi/Documents/My Dropbox/Projects/SU2C/ER/TophatCufflinks/formattedFiles/MCF7L_fpkm.txt"

outdir="C:/Users/Obi/Documents/My Dropbox/Projects/SU2C/ER/TophatCufflinks/plotsTables"
...
libnames_clean=c("SE2","SED","STam","LE2","LEDR","LTamR","P")
...
heatmap.2(x, hclustfun=myclust, distfun=mydist, na.rm = TRUE, scale="none", symbreaks=FALSE, key=TRUE, symkey=FALSE, density.info="none", trace="none", main=main_title, labRow=libnames_clean, labCol=gene_names, cexRow=0.8, cexCol=0.60, col=rev(heat.colors(75)))
dev.off()
