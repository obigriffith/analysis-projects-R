...
datadir="C:/Users/Obi/Documents/My Dropbox/Projects/SU2C/HER2/TophatCufflinks/plotsTables/Her2_sigDe_combined/"
resultdir="C:/Users/Obi/Documents/My Dropbox/Projects/SU2C/HER2/TophatCufflinks/plotsTables/candidate_analysis/"
...
#For each model and each drug treatment (L, T or L+T) find subset of genes that match the desired pattern
#Significantly up-regulated in resistant versus parental (e.g., PvsLR)
BT474AZ_PvsLLR = which(combined_data[,"sample_1"]=="BT474AZ_P" & combined_data[,"sample_2"]=="BT474AZ_LLR" & combined_data[,"fold_change_computed"]>1)
#Significantly up-regulated in resistant versus sensitive (e.g., PLvsLR) conditions
BT474AZ_PLvsLR = which(combined_data[,"sample_1"]=="BT474AZ_PL" & combined_data[,"sample_2"]=="BT474AZ_LR" & combined_data[,"fold_change_computed"]>1)
#Find overlap between those gene sets
overlap=combined_data[BT474AZ_PvsLLR,"gene_id"][which(combined_data[BT474AZ_PvsLLR,"gene_id"] %in% combined_data[BT474AZ_PLvsLR,"gene_id"])]
